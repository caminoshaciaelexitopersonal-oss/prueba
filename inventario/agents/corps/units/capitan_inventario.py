# inventario/agents/corps/units/capitan_inventario.py
from typing import TypedDict, Annotated
from langchain_openai import ChatOpenAI
from langchain_core.messages import BaseMessage
from langgraph.graph import StateGraph, END

# Importar las herramientas tácticas de inventario
from inventario.agents.tools.inventario_tools import inventario_tools

class AgentState(TypedDict):
    """Define el estado del agente."""
    messages: Annotated[list, lambda x, y: x + y]

class InventarioCaptain:
    """
    El 'Capitán de Inventario' es un agente especializado en gestionar
    el stock, crear productos y registrar movimientos de inventario.
    """
    ...
    def _call_tool(self, state: AgentState):
        ...
        for tool_call in message.tool_calls:
            ...
            selected_tool = next((t for t in inventario_tools if t.name == tool_name), None)
            if selected_tool:
                try:
    ...
    def run(self, query: str):
        ...
        initial_messages = [{"role": "system", "content": "Eres un asistente experto en gestión de inventarios. Ayuda al usuario a crear productos, consultar stock y registrar movimientos como compras o ventas. Usa las herramientas disponibles para completar las tareas."},
