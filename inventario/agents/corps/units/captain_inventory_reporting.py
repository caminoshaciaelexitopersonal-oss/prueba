# agentes/corps/units/captain_inventory_reporting.py
"""
Define el grafo del agente Capitán de Reportería de Inventario.
Este agente es un especialista en generar reportes de productos y stock.
"""
import operator
...
from ..tools.inventory_tools import (
    obtener_listado_productos_tool,
    obtener_kardex_de_producto_tool,
)
...
def get_inventory_reporting_captain_graph(llm):
    ...
    reporting_captain_prompt = HumanMessage(
        content="""Eres un Capitán especialista en reportería de inventarios.
Tu misión es generar el reporte de stock o el kardex de producto que se te solicita.
