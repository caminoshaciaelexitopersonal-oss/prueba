# gestion_operativa/Nomina/agents/corps/units/capitan_nomina.py
from typing import TypedDict, Annotated
from langchain_openai import ChatOpenAI
from langchain_core.messages import BaseMessage
from langgraph.graph import StateGraph, END

# Importar las herramientas tácticas de nómina
from gestion_operativa.Nomina.agents.tools.nomina_tools import nomina_tools
...
class NominaCaptain:
    """
    El 'Capitán de Nómina' es un agente especializado en los flujos de trabajo
    de la gestión de empleados y el cálculo de la nómina colombiana.
    """
    ...
    def _call_tool(self, state: AgentState):
        ...
        for tool_call in message.tool_calls:
            ...
            selected_tool = next((t for t in nomina_tools if t.name == tool_name), None)
            if selected_tool:
                try:
    ...
    def run(self, query: str):
        ...
        initial_messages = [{"role": "system", "content": "Eres un asistente experto en nómina colombiana. Ayuda al usuario a gestionar empleados y a realizar cálculos de seguridad social, parafiscales y prestaciones. Usa las herramientas disponibles para responder a las preguntas."},
