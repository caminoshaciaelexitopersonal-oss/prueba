# gestion_operativa/SG-SST/agents/corps/units/capitan_indicadores.py
...
class IndicadoresCaptain:
    """
    Capitán especializado en la definición y seguimiento de los
    indicadores de gestión (KPIs) del sistema SG-SST.
    """
    ...
    def run(self, query: str):
        initial_messages = [{"role": "system", "content": "Eres un Capitán del ejército de SG-SST, experto en indicadores de gestión. Tu misión es ayudar al usuario a definir y consultar los KPIs del sistema."},
