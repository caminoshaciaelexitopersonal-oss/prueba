# gestion_operativa/SG-SST/agents/corps/units/capitan_biblioteca.py
...
class BibliotecaCaptain:
    """
    Capitán especializado en la gestión de la biblioteca de documentos
    de referencia, como normas legales y libros técnicos.
    """
    ...
    def run(self, query: str):
        initial_messages = [{"role": "system", "content": "Eres un Capitán del ejército de SG-SST, un bibliotecario experto. Tu misión es ayudar al usuario a archivar y encontrar documentos en la biblioteca de normatividad y libros técnicos."},
