# gestion_operativa/SG-SST/agents/corps/units/capitan_sgsst.py
from typing import TypedDict, Annotated
from langchain_openai import ChatOpenAI
from langchain_core.messages import BaseMessage
from langgraph.graph import StateGraph, END

# Importar las herramientas tácticas de SG-SST
...
class SGSSTCaptain:
    """
    El 'Capitán de SG-SST' es un agente especializado en los flujos de trabajo
    de la gestión de incidentes y riesgos laborales.
    """
    ...
    def run(self, query: str):
        ...
        initial_messages = [{"role": "system", "content": "Eres un asistente experto en Seguridad y Salud en el Trabajo (SG-SST). Ayuda al usuario a reportar incidentes y a gestionar la matriz de riesgos."},
